--- Shared unit logic.
-- @author Darrell
-- #include <~/TI4-TTS/TI4/Helpers/TI4_UnitHelper>
...
local _unitTypes = {
    ...
    ['War Sun'] = {
        ship = true,
		spaceCombat = { dice = 0, hit = 99 },
		bombardment = { dice = 0, hit = 99 },
    },
}
...
local _unitOverrides = {
    ...
    -- Codex 3
    ['Artemiris'] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 7 }, capacity = 6 },
    ...
    ['Iconoclast '] = { override = 'Mech' }, --TE DEPLOY version
    ['Iconoclast Ω'] = { override = 'Mech' },
    ...
    ['Omniopiares'] = { override = 'Mech' },
	
	----- Thunder's Edge Units
	----- Flagships
    ['The Egeiro'] = { override = 'Flagship', spaceCombat = { dice = 1, hit = 9 }, },
	['Last Dispatch'] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 8 }, capacity = 4 },
	['Quietus'] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 5 }, },
	['DWS Luminous'] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 7 }, capacity = 6 },
	["Heaven's Eye"] = { override = 'Flagship',spaceCombat = { dice = 2, hit = 5 } },
	----- Flagship Upgrades
	["Heaven's Hollow"] = { override = 'Flagship', spaceCombat = { dice = 3, hit = 5 } },
    ----- Mechs
    ['A3 Valiance'] = { override = 'Mech', },
	['Alarum'] = { override = 'Mech', },
	['Revenant'] = { override = 'Mech', },
	...
	['Exile II'] = { upgrade = 'Destroyer', spaceCombat = { hit = 7 }, antiFighterBarrage = { dice = 3, hit = 6}, },
	
	-- Naaz Rohka Breakthrough (bugged spaceCombat doesn't update changed to Unit Modifier)
	-- ['Eidolon Maximum'] = {  upgrade = 'Mech', spaceCombat = {dice = 4, hit = 4, requireSpace = true }, groundCombat = { dice = 4, hit = 4, requireGround = true} },
	-- Mentak Breakthrough
	['Corsair'] = { upgrade = 'Cruiser', spaceCombat = { hit = 6 }, move = 3, capacity = 2 },
	
	-- Twilight Fall
	-- Flagships
	["A Strangled Whisper"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 7 }, capacity = 1 },
    ["Enigma"] = { override = 'Flagship', spaceCombat = { dice = 1, hit = 7 }, capacity = 7 },
    ["Tizona"] = { override = 'Flagship', spaceCombat = { dice = 1, hit = 3 }, capacity = 6 },
    ["Scintilla"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 9 }, capacity = 3 },
    ["The Faces of Janovet"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 5 }, capacity = 3 },
    ["Nightbloom"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 7 }, capacity = 4,  move = 2 },
    ["The Scarlet Knife"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 7 }, },
    ["Airo Shir Rex"] = { override = 'Flagship', spaceCombat = { dice = 2, hit = 5 }, antiFighterBarrage = {dice = 3, hit = 5}, capacity = 3 },
	-- Mechs
	['Bone Picked Clean'] = { override = 'Mech', groundCombat = { dice = 2, hit = 5 }, },
    ['Starlancer XI'] = { override = 'Mech', groundCombat = { dice = 1, hit = 6}, spaceCombat = { dice = 1, hit = 6 }, },
    ['Colada'] = { override = 'Mech', },
    ['Delver'] = { override = 'Mech', },
    ['Analyzer'] = { override = 'Mech', },
    ["Lakoe's Roots"] = { override = 'Mech', },
    ['The Sharpened Edge'] = { override = 'Mech', },
    ['Starlancer II'] = { override = 'Mech', },
	-- Unit Upgrades
	['TF War Sun'] = { override = 'War Sun', spaceCombat = { dice = 2, hit = 5 }, bombardment = { dice = 3, hit = 5 }, capacity = 6 },
    ['TF Prototype War Sun'] = { upgrade = 'War Sun', spaceCombat = { dice = 3, hit = 3 }, bombardment = { dice = 3, hit = 3 }, move =  2 },
    ['TF University War Sun'] = { upgrade = 'War Sun', spaceCombat = { dice = 3, hit = 4 }, bombardment = { dice = 3, hit = 4 }, move =  3 },
    ['TF The Dragon Freed'] = { upgrade = 'War Sun', spaceCombat = { dice = 3, hit = 3 }, bombardment = { dice = 3, hit = 3 }, move =  2 },
    ['TF Exotrireme'] = { upgrade = 'Dreadnought', spaceCombat = { dice = 1, hit = 4 }, bombardment = { dice = 2, hit = 4 }, move = 2 },
    ['TF Dawncrusher'] = { upgrade = 'Dreadnought', cost = 3, spaceCombat = { dice = 1, hit = 5 }, bombardment = { dice = 1, hit = 4 }, move = 2 },
	["TF Super-Dreadnought"] = { upgrade = 'Dreadnought', spaceCombat = { dice = 1, hit = 5 }, bombardment = { dice = 1, hit = 4 }, capacity = 2, move = 2 },
    ['TF Corsair'] = { upgrade = 'Cruiser', spaceCombat = {dice = 1, hit = 6}, move = 3 },
    ['TF Ahk Syl Fier'] = { upgrade = 'Cruiser', spaceCombat = {dice = 1, hit = 6}, move = 3 },
    ['TF Saggitaria'] = { upgrade = 'Cruiser', spaceCombat = {dice = 1, hit = 6}, move = 3 },
    ['TF Strike Wing Alpha'] = { upgrade = 'Destroyer', spaceCombat = { dice = 1, hit = 7}, antiFighterBarrage = {dice = 3, hit = 6}, move = 2 },
    ['TF Exile'] = { upgrade = 'Destroyer', spaceCombat = { dice = 1, hit = 8}, antiFighterBarrage = {dice = 3, hit = 6}, move = 4 },
    ['TF Linkship'] = { upgrade = 'Destroyer', spaceCombat = { dice = 1, hit = 8}, antiFighterBarrage = {dice = 3, hit = 6}, move = 2 },
    ['TF Advanced Carrier'] = { upgrade = 'Carrier', spaceCombat = { dice = 1, hit = 9}, move = 2 },
    ['TF Ambassador'] = { upgrade = 'Carrier', spaceCombat = { dice = 1, hit = 9}, move = 2 },
    ['TF Vortexer'] = { upgrade = 'Carrier', spaceCombat = { dice = 1, hit = 9}, },
    ['TF Valefar Prime'] = { upgrade = 'Mech', cost = 1 },
    ['TF Hybrid Crystal Fighter'] = { upgrade = 'Fighter', spaceCombat = { dice = 1, hit = 7 }, move = 2 },
    ['TF Triune'] = { upgrade = 'Fighter', spaceCombat = { dice = 1, hit = 7 }, move = 2 },
    ['TF Morphwing'] = { upgrade = 'Fighter', spaceCombat = { dice = 1, hit = 7 }, groundCombat = { dice = 1, hit = 7 }, move = 2 },
    ['TF Yin Clone'] = { upgrade = 'Infantry', groundCombat = { hit = 7 }, },
    ['TF Letani Warrior'] = { upgrade = 'Infantry', production = 2, groundCombat = { hit = 7 }, },
    ['TF Guild Agents'] = { upgrade = 'Infantry', groundCombat = { hit = 7 }, },
    ['TF Hel-Titan'] = { upgrade = 'PDS', production = 1, groundCombat = { hit = 5 }, spaceCannon = { dice = 1, hit = 5, range = 1 }, },
    ['TF Keeper Matrix'] = { upgrade = 'PDS', spaceCannon = { dice = 2, hit = 5, range = 1 }, },
    ['TF Justicier Rail'] = { upgrade = 'PDS', spaceCannon = { dice = 1, hit = 5, range = 1 }, },
    ['TF Production Biomes'] = { upgrade = 'Space Dock', production = 9, },
    ['TF Floating Factories'] = { upgrade = 'Space Dock', production = 7, capacity = 5, move = 2 },
    ['TF Helios Entity'] = { upgrade = 'Space Dock', },	
...
local _flagshipModifiers = {
    ...
    ['Salai Sai Corian'] = {
        ...
        apply = function(unitAttrs, params)
            ...
            if params.opponentUnitTypeToCount then
                ...
                -- The NRA mech count as ships when in space.  The opponent
                -- data is only a map from unit type to count, without positions
                -- to do the check.

                -- Get opponent unit attributes (franken friendly).
                local colorToUnitOverrides = getColorToUnitOverrides()
                local unitOverrides = params.opponentColor and colorToUnitOverrides[params.opponentColor]
                local opponentUnitAttrs = getUnitAttributes(unitOverrides or {})

                count = 0
                local opponentUnitTypeToCount = params.opponentUnitTypeToCount or {}
                for unitType, attr in pairs(opponentUnitAttrs) do
                    local include = attr.ship and (unitType ~= 'Fighter') and attr.spaceCombat
                    -- NRA Mech are ships when not on planets.  The unit type to count
                    -- table does not have position data, but the autofill tool already
                    -- applied this restriction when finding units for space combat.
                    if attr.spaceCombat and attr.spaceCombat.requireSpace then
                        include = true
                    end
                    if include then
	...
	-- Thunders Edge Expansion Flagships
	
	['The Egeiro'] = {
        description = "Apply +1 to the results of each of this units combat rolls for each non-homesystem that contains a planet you control.",
        owner = OWNER.SELF,
        type = TYPE.MUTATE,
        isCombat = true,
        apply = function(unitAttrs, params)
				if unitAttrs['Flagship'] then
					local count = 0 
					local _systems = _systemHelper.systems()
				
					local planetsOwned = {}
					for _, object in ipairs(getAllObjects()) do
						if object.tag == 'Card' and _zoneHelper.zoneFromPosition(object.getPosition()) == params.myColor then
							table.insert(planetsOwned, object.getName())
						end
					end
			
					for _, system in pairs(_systems) do
						local isSystemUnique = true
						if not system.home and system.planets then
							for _, planet in ipairs(system.planets) do
								for _, planetCheck in ipairs(planetsOwned) do
									if isSystemUnique and planet.name == planetCheck and not planet.station then
										count = count + 1
										isSystemUnique = false
									end
								end
							end
						end
					...
					unitAttrs['Flagship'].spaceCombat.hit = unitAttrs['Flagship'].spaceCombat.hit - count
					if unitAttrs['Flagship'].spaceCombat.hit < 1 then
						unitAttrs['Flagship'].spaceCombat.hit = 1
					end
...
local _unitModifiers = {
    ...
    ['Blitz'] = {
        ...
        apply = function(unitAttrs)
            for unitType, attr in pairs(unitAttrs) do
                if attr.ship and (unitType ~= 'Fighter') and not attr.bombardment then
    ...
    ['Brother Omar'] = {
        ...
        isCombat = false,
        apply = function(unitAttrs)
            local oldCost = unitAttrs['Infantry'].cost
            local oldUnitsPerResource = math.floor(0.5 + (1.0 / oldCost)) -- math.round
            local newUnitsPerResource = oldUnitsPerResource + 1
            local newCost = 1.0 / newUnitsPerResource
            unitAttrs['Infantry'].cost = newCost

            local oldProductionConsumed = unitAttrs['Infantry'].productionConsumed or 1
            local newProductionConsumed = (oldUnitsPerResource / newUnitsPerResource) * oldProductionConsumed
    ...
    ['Emissary Taivra'] = {
        leader = LEADER.AGENT, -- Ghosts
        description = 'Active with-wormhole system is adjacent to other wormholes',
        owner = OWNER.ANY,
        type = TYPE.CHOOSE,
        isCombat = false,
        toggleActive = true,
	 ...
	 -- Changed to Support Lightrail Ordnance, only changes the stats on the first space 
    ...
    ["M'aban"] = {
        ...
        isCombat = false,
        apply = function(unitAttrs, params)
            local oldCost = unitAttrs['Fighter'].cost
            local oldUnitsPerResource = math.floor(0.5 + (1.0 / oldCost)) -- math.round
            local newUnitsPerResource = oldUnitsPerResource + 1
            local newCost = 1.0 / newUnitsPerResource
            unitAttrs['Fighter'].cost = newCost

            local oldProductionConsumed = unitAttrs['Fighter'].productionConsumed or 1
            local newProductionConsumed = (oldUnitsPerResource / newUnitsPerResource) * oldProductionConsumed
    ...
    ['Prophecy of Ixth'] = {
        ...
        isCombat = true,
        apply = function(unitAttrs)
            local attrs = unitAttrs['Fighter']
            attrs.spaceCombat.hit = attrs.spaceCombat.hit - 1
            if attrs.groundCombat then
                attrs.groundCombat.hit = attrs.groundCombat.hit - 1
            end
        end
    },
    ...
    ['Ta Zern'] = {
        ...
        leader = LEADER.COMMANDER,  -- Jol-Nar
        owner = OWNER.SELF,
        type = TYPE.ADJUST,
        isCombat = true,
        toggleActive = true,
	...
	['Custodia Vigilia (L)'] = {
		description = 'Mecatol Rex gains Space Cannon 5',
		owner = OWNER.SELF,
		type = TYPE.MUTATE,
		isCombat = true,
		toggleActive = true,
		apply = function(unitAttrs, params)
			unitAttrs['Mecatol Rex'] = { spaceCannon = { dice = 1, hit = 5 }, unitCount = 1 }
		end
	},
	
	-- Codex'd X-89 Bacterial Weapon
	-- In the multiroller .x89Bonus will add two hits instead of one if true
	['X-89 Bacterial Weapon'] = {
		description = 'Double BOMBARDMENT and ground combat hits.',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		apply = function(unitAttrs, params)
			for unitType, attr in pairs(unitAttrs) do
				if attr.bombardment then
					attr.bombardment.x89Bonus = true
				end
				if attr.groundCombat then
					attr.groundCombat.x89Bonus = true
				end
			end
		end
	},

	-- Thunders Edge Expansion
	
	['Metali Void Armaments'] = {
	description = 'You may resolve ANTI-FIGHTER BARRAGE 6x3',
	owner = OWNER.SELF,
	type = TYPE.MUTATE,
	isCombat = true,
	toggleActive = true,
	apply = function(unitAttrs, params)
			unitAttrs['Metali Void Armaments'] = {
	...
	['Lightrail Ordnance'] = {
	description = 'Space Docks gain SPACECANNON 5x2',
	owner = OWNER.SELF,
	type = TYPE.MUTATE,
	isCombat = true,
	toggleActive = true,
	apply = function(unitAttrs, params)
			-- Only apply to Space Dock units
			if unitAttrs["Space Dock"] then
				unitAttrs["Space Dock"].spaceCannon = { allow = true, hit = 5, dice = 2, range = 1, extraDice = 0 }
			end
		end
	},
	...
	-- Aroz Hollow but no Obsidian Faction (Obsidian is a faction now)
	['Obsidian Alliance'] = {
        description = '+1 to combat rolls',
       owner = OWNER.SELF,
        type = TYPE.ADJUST,
	...
	['Miniaturize'] = {
		description = 'Structures with Space Cannon must be on a planet.',
		owner = OWNER.SELF,
		type = TYPE.CHOOSE,
		isCombat = true,
		apply = function(unitAttrs, params)
			for unitType, attr in pairs(unitAttrs) do	
				if attr.spaceCannon and attr.structure then
					attr.spaceCannon.requireGround = true
				end
			end
		end
	},
	...
	['Imperator'] = {
		description = '+1 to combat rolls for each Support in opponents play area',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		toggleActive = true,
		apply = function(unitAttrs, params)
			if not params.opponentColor then return end
			local count = 0
			for _, object in ipairs(getAllObjects()) do
				local name = object.getName()
				if name:match('^Support for the Throne') and not name:find(params.opponentColor, 1, true) then
					if params.opponentColor == _zoneHelper.zoneFromPosition(object.getPosition()) then
						count = count + 1
					end
				end
			end
			...
			if count > 0 then
				for _, attr in pairs(unitAttrs) do
					if attr.spaceCombat then
						attr.spaceCombat.hit = attr.spaceCombat.hit - count
					end
					if attr.groundCombat then
						attr.groundCombat.hit = attr.groundCombat.hit - count
					end
				end
			end
		end
	...
	['Gravleash Maneuvers'] = {
		description = '+1 to this units combat rolls for each ship type',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		toggleActive = true,
		apply = function(unitAttrs, params)
			...
			local gravleashShip = nil
			local count = 0
			for _, object in ipairs(getAllObjects()) do
				if object.tag == 'Card' and object.getName() == 'Gravleash Maneuvers' then
					local bounds = object.getBounds()
					thisObjectBB.min = {x = bounds.center.x - bounds.size.x / 2, z = bounds.center.z - bounds.size.z / 2}
					thisObjectBB.max = {x = bounds.center.x + bounds.size.x / 2, z = bounds.center.z + bounds.size.z / 2}
				end
				if object.tag == 'Generic' and object.getName() == arenaName then
					local bounds = object.getBounds()
					arenaObjectBB.min = {x = bounds.center.x - bounds.size.x / 2, z = bounds.center.z - bounds.size.z / 2}
					arenaObjectBB.max = {x = bounds.center.x + bounds.size.x / 2, z = bounds.center.z + bounds.size.z / 2}
				end
				if thisObjectBB.min and thisObjectBB.max and arenaObjectBB.min and arenaObjectBB.max then break end
			end
			if activeSystem and thisObjectBB.min and thisObjectBB.max then
				for _, unit in ipairs(getUnits()) do
					local p = unit.position
					local system = _systemHelper.systemFromPosition(p)
					if arenaObjectBB.min and arenaObjectBB.max and p.x >= arenaObjectBB.min.x and p.x <= arenaObjectBB.max.x and p.z >= arenaObjectBB.min.z and p.z <= arenaObjectBB.max.z then
						system = activeSystem
					end
					if system and system.guid == activeSystem.guid and unitAttrs[unit.unitType].ship and (unit.color == params.myColor or unit.name == unitAttrs['Flagship'].name) then
						local uniq = true
						for _, shipType in ipairs(activeShipType) do
							if unit.unitType == shipType then
								uniq = false
								break
							end
						end
						if uniq then
							table.insert(activeShipType, unit.unitType)
							count = count + 1
						end
					elseif p.x >= thisObjectBB.min.x and p.x <= thisObjectBB.max.x and p.z >= thisObjectBB.min.z and p.z <= thisObjectBB.max.z then
						gravleashShip = _copy(unitAttrs[unit.unitType])
						local uniq = true
						for _, shipType in ipairs(activeShipType) do
							if unit.unitType == shipType then
								uniq = false
			...
			if gravleashShip then
				unitAttrs['Gravleash Maneuvers'] = gravleashShip
				unitAttrs['Gravleash Maneuvers'].name = 'Gravleash Maneuvers'
				if unitAttrs['Gravleash Maneuvers'].spaceCombat and unitAttrs['Gravleash Maneuvers'].spaceCombat.hit then
					unitAttrs['Gravleash Maneuvers'].spaceCombat.hit = unitAttrs['Gravleash Maneuvers'].spaceCombat.hit - count
					unitAttrs['Gravleash Maneuvers'].unitCount = 1
				end
			end
		end
	},
	...
	['Eidolon Maximum'] = {
		...
		type = TYPE.MUTATE,
		apply = function(unitAttrs, params)
			unitAttrs['Mech'] = { spaceCombat = { dice = 4, hit = 4 }, groundCombat = { dice = 4, hit = 4 }, name = 'Eidolon Maximum', ship = true, move = 3 }
		end
	},
	
	['Assail'] = {
		description = '+1 to combat and ability rolls against the puppeted player',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		toggleActive = true,
		apply = function(unitAttrs, params)
			for unitType, attrs in pairs(unitAttrs) do
				...
				if attrs.spaceCannon then
					attrs.spaceCannon.hit = attrs.spaceCannon.hit - 1
				end
				if attrs.antiFighterBarrage then
					attrs.antiFighterBarrage.hit = attrs.antiFighterBarrage.hit - 1
				end
				if attrs.bombardment then
					attrs.bombardment.hit = attrs.bombardment.hit - 1
				end
			end
		end
	},
	...
	['Colada'] = {
		description = 'Mech Ability',
		owner = OWNER.SELF,
		type = TYPE.CHOOSE,
		apply = function(unitAttrs, params)
			local myMechs = {}
			local arenaName = 'TI4 Auto-fill MultiRoller Arena'
			local bbToArenaObject = {}
			local activatedSystem = _systemHelper.getActivatedSystem()
			local activatedSystemObject, activeSystemHex = nil, nil
			local best = nil
			local count = 0
			if activatedSystem then
				activatedSystemObject = getObjectFromGUID(activatedSystem.guid)
				activeSystemHex = _systemHelper.hexFromPosition(activatedSystemObject.getPosition())
				for _, unit in ipairs(getUnits()) do
					if unit.unitType == 'Mech' and unit.color == params.myColor then
						table.insert(myMechs, unit)
					end
				end
				for _, object in ipairs(getAllObjects()) do
					if object.getName() == arenaName then
						local bounds = object.getBounds()
						table.insert(bbToArenaObject, {
				...
				if #bbToArenaObject > 0 then
					for _, mech in ipairs(myMechs) do
						local p = mech.position
						for _, bbData in ipairs(bbToArenaObject) do
							local bb = bbData
							local arenaObject = bbData.arenaObject
				...
				for _, mech in ipairs(myMechs) do
					local onPlanet = _systemHelper.planetFromPosition({
						systemGuid = activatedSystem.guid,
						position = mech.position,
						exact = true
					})
					if mech.hex == activeSystemHex and not onPlanet then
						count = count + 1
					end
				end
				if count > 0 then
					for unitType, attr in pairs(unitAttrs) do
						-- Check for units present, then check for dynamically injected units, then default to 0
						local unitCount = params.myUnitTypeToCount[unitType] or attr.unitCount or 0
						if attr.capacity and attr.spaceCombat and unitCount > 0 then
							if (not best) or (attr.spaceCombat.hit < best.spaceCombat.hit) then
								best = attr
							end
						end
					...
					if best then
						best.spaceCombat.extraDice = (best.spaceCombat.extraDice or 0) + count
					end
				end
			end
		end
	...
	['Starlancer XI'] = {
		...
		apply = function(unitAttrs, params)
			...
			if activatedSystem then
				...
				for _, hex in ipairs(uniq) do
					local system = _systemHelper.systemFromPosition(_systemHelper.hexToPosition(hex))
					if system and system.anomalies then
						count = count + 1
					end
				end
				if unitAttrs['Mech'].spaceCombat then
					unitAttrs['Mech'].spaceCombat.hit = (unitAttrs['Mech'].spaceCombat.hit or 11) - count
				end
				if unitAttrs['Mech'].groundCombat then
					unitAttrs['Mech'].groundCombat.hit = (unitAttrs['Mech'].groundCombat.hit or 11) - count
				end
			end
		end
	},
	
	['TF Echo of Ascension'] = { 
		description = "Flagship Upgrade",
		owner = OWNER.SELF,
		type = TYPE.MUTATE,
		apply = function(unitAttrs, params)
			if unitAttrs['Flagship'].spaceCombat then
				unitAttrs['Flagship'].spaceCombat.dice = (unitAttrs['Flagship'].spaceCombat.dice or 0) + 1
				unitAttrs['Flagship'].spaceCombat.hit = (unitAttrs['Flagship'].spaceCombat.hit or 0) - 1
			end
		end
	},
	
	['TF Eidolon Landwaster'] =  {
		description = "Mech Upgrade",
		owner = OWNER.SELF,
		type = TYPE.MUTATE,
		apply = function(unitAttrs, params)
			if unitAttrs['Mech'].spaceCombat then
				unitAttrs['Mech'].spaceCombat.dice = (unitAttrs['Mech'].spaceCombat.dice or 0) + 1
			end
			if unitAttrs['Mech'].groundCombat then
				unitAttrs['Mech'].groundCombat.dice = (unitAttrs['Mech'].groundCombat.dice or 0) + 1
			end
		end
	},
	...
	['TF Eidolon Terminus'] = {
		...
		apply = function(unitAttrs, params)
			if unitAttrs['Mech'].spaceCombat then
				unitAttrs['Mech'].spaceCombat.hit = (unitAttrs['Mech'].spaceCombat.hit or 99) - 1
			end
			if unitAttrs['Mech'].groundCombat then
				unitAttrs['Mech'].groundCombat.hit = (unitAttrs['Mech'].groundCombat.hit or 99) - 1
			end
		end
	},
	...
	['TF Tactical Brilliance'] = {
        description = 'You may reroll any dice for a unit ability',
        owner = OWNER.SELF,
        type = TYPE.ADJUST,
        isCombat = true,
        toggleActive = true,
	...
	['TF Zealous'] = {
        description = '+1 die to a unit ability',
        owner = OWNER.SELF,
        type = TYPE.CHOOSE,
        isCombat = true,
        toggleActive = true,
	...
	['TF Supercharge'] = {
		description = '+2 to this units combat rolls',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		toggleActive = true,
		apply = function(unitAttrs, params)
			local activeSystem = _systemHelper.getActivatedSystem()
			local thisObjectBB = {}
			local superchargeShip = nil
			for _, object in ipairs(getAllObjects()) do
				if object.tag == 'Card' and object.getName() == 'TF Supercharge' and _zoneHelper.zoneFromPosition(object.getPosition()) == params.myColor then
					local bounds = object.getBounds()
					thisObjectBB.min = {x = bounds.center.x - bounds.size.x / 2, z = bounds.center.z - bounds.size.z / 2}
					thisObjectBB.max = {x = bounds.center.x + bounds.size.x / 2, z = bounds.center.z + bounds.size.z / 2}
					break
			...
			if activeSystem and thisObjectBB.min and thisObjectBB.max then
				for _, unit in ipairs(getUnits()) do
					local p = unit.position
					local system = _systemHelper.systemFromPosition(p)
					if p.x >= thisObjectBB.min.x and p.x <= thisObjectBB.max.x and p.z >= thisObjectBB.min.z and p.z <= thisObjectBB.max.z then
						superchargeShip = _copy(unitAttrs[unit.unitType])
					end
				end
			end
			if superchargeShip then
				unitAttrs['Supercharge'] = superchargeShip
				unitAttrs['Supercharge'].name = 'Supercharge'
				if unitAttrs['Supercharge'].spaceCombat and unitAttrs['Supercharge'].spaceCombat.hit then
					unitAttrs['Supercharge'].spaceCombat.hit = unitAttrs['Supercharge'].spaceCombat.hit - 2
					unitAttrs['Supercharge'].unitCount = 1
				end
				if unitAttrs['Supercharge'].groundCombat and unitAttrs['Supercharge'].groundCombat.hit then
					unitAttrs['Supercharge'].groundCombat.hit = unitAttrs['Supercharge'].groundCombat.hit - 2
					unitAttrs['Supercharge'].unitCount = 1
				end
			end
		end
	...
	['Trine'] = {
		description = 'Units can use SPACECANNON up to 2 systems away',
		owner = OWNER.SELF,
		type = TYPE.ADJUST,
		isCombat = true,
		apply = function(unitAttrs, params)
			for unitType, attrs in ipairs(unitAttrs) do
				if attrs.spaceCannon then
					attrs.spaceCannon.range = 2
				end
			end
		end
	},
...
function applyFlagshipModifiers(params)
    ...
    local modifiers = {}
    local function _findAssimilatedFlagships()
        local zAssimilator, zTokens = false, {} --color to boolean
        for _,each in ipairs(getAllObjects()) do
            if each.type == "Card" then
                if each.getName() == 'Valefar Assimilator Z' then
                    local zoneColor = _zoneHelper.zoneFromPosition(each.getPosition())
                    if zoneColor then
                        zAssimilator = zoneColor
                    end
                end
            elseif each.getName() == 'Valefar Assimilator Z Token' then
                local zoneColor = _zoneHelper.zoneFromPosition(each.getPosition())
                if zoneColor then zTokens[zoneColor] = true end
            end
        end
        
        if not zAssimilator or zAssimilator ~= params.myColor then return {} end

        zTokens[zAssimilator] = nil --dont copy self
        local factions = _factionHelper.allFactions()
        local copiedFlags = {}
        for color,_ in pairs(zTokens) do
            if factions[color] and factions[color].flagship then
                table.insert(copiedFlags, factions[color].flagship)
            end
        end
        return copiedFlags --hash of flagship name to boolean
    end

    if params.myUnitTypeToCount and (params.myUnitTypeToCount['Flagship'] or 0) > 0 then
        local myFlag = unitAttrs['Flagship'].name
        local flagships = _findAssimilatedFlagships()

        if myFlag then
            local unitModifier = _flagshipModifiers[myFlag]
            if unitModifier and unitModifier.owner == OWNER.SELF then
                table.insert(modifiers, myFlag)
                unitModifier.apply(unitAttrs, params)
            end
        end
        for _,each in ipairs(flagships) do
            local unitModifier = _flagshipModifiers[each]

            --Look for some printed abilities that are baked into unit table.
            local flagData = _unitOverrides[each] or {}
            if flagData.spaceCombat then --JolNar
                unitAttrs['Flagship'].spaceCombat.extraHitsOn = _copy(flagData.spaceCombat.extraHitsOn)
            end
            if flagData.disablePlanetaryShield then --Barony
                unitAttrs['Flagship'].disablePlanetaryShield = true
            end
            if flagData.groundCombat then --idk, some homebrew maybe
            unitAttrs['Flagship'].groundCombat = _copy(flagData.groundCombat)
            end

            if unitModifier and unitModifier.owner == OWNER.SELF then
                table.insert(modifiers, each)
                unitModifier.apply(unitAttrs, params)
            end
        end
    end
    ...
    for _, modifier in ipairs(modifiers) do
        table.insert(unitAttrs._flagshipModifiers, {
            ...
            isCombat = _flagshipModifiers[modifier].isCombat,
        })
    end
...
function applyUnitModifiers(params)
    ...
    for _, modifier in ipairs(modifiers) do
        table.insert(unitAttrs._unitModifiers, {
            ...
            isCombat = _unitModifiers[modifier].isCombat,
        })
    end
    return unitAttrs
end
...
function getColorToUnitModifiers()
    ...
    -- Faction helper looks at alliance cards when they have toggle active,
    -- as well as if the linked commander is active when unable to (imperia).
    -- It is safe to trust faction helper returns only valid commanders.
    ...
    for _, object in ipairs(getAllObjects()) do
        ...
        if unitModifier then
            ...
            -- Unfortunately do not know "opponent color" here, cannot know
            -- who is fighting who; if Tekklar is on the table always debuff
            -- Sardakk, rely on card being used and disposed of correctly.
...
local _objectNameToUnitDataTimestamp = false

function _getObjectNameToUnitData()
    if _objectNameToUnitData and _objectNameToUnitDataTimestamp then
        local age = Time.time - _objectNameToUnitDataTimestamp
        if age < 60 then
            return _objectNameToUnitData
        end
    end
    _objectNameToUnitDataTimestamp = Time.time
...
function isUnitName(name)
    assert(type(name) == 'string')
    local objectNameToUnitData = _getObjectNameToUnitData()
    return objectNameToUnitData[name] and true or false
end
...
function getUnits()
    ...
    for _, object in ipairs(getAllObjects()) do
        local name = object.getName()
        local unitData = objectNameToUnitData[name]
        -- Treat 'figurine' as 'generic'.
        local tag = object.tag == 'Figurine' and 'Generic' or object.tag
        if (not object.held_by_color) and unitData and ((not unitData.tag) or unitData.tag == tag) then
            local unitData = _copy(unitData)
            unitData.guid = object.getGUID()
            unitData.position = object.getPosition()
			unitData.name = name
            if name == 'Infantry Counter' or name == 'Fighter Counter' then
                -- Require object store count in a global.  Object.getValue not universal.
                local count = object.getVar('_unitCount')
                if count and type(count) == 'number' and count >= 0 then
                    unitData.count = count
                end
            end
...
function getUnitTypeToCount(units)
    ...
    for _, unit in ipairs(units) do
        unitTypeToCount[unit.unitType] = (unitTypeToCount[unit.unitType] or 0) + (unit.count or 1)
    end
...
function _isToggleActiveCard(object)
    if object.tag == 'Card' then
        ...
        if modifier then
            return modifier.toggleActive
        end

        -- Add toggle active for alliance cards where the peer is toggle active.
        -- Do not use an alias should only actually get used when linked
        -- commander is active, let faction helper look at the toggle active
        -- status and decide when an alliance is in play.
        ...
        local modifier = commander and _unitModifiers[commander]
        if modifier and modifier.alias then
            modifier = _unitModifiers[modifier.alias]
        end
        if modifier then
        ...
        -- COMMENTED OUT FOR NOW, ONLY USE NEW STYLE.  Also support the old style.
        -- local factionColor = string.match(name, '^Alliance %((.*)%)$')
        -- local faction = factionColor and _factionHelper.fromColor(factionColor)
        -- local commander = faction and faction.commander
        -- local modifier = commander and _unitModifiers[commander]
        -- if modifier and modifier.alias then
        --     modifier = _unitModifiers[modifier.alias]
...
function _dumpUnits()
    ...
    local adjacentSet = {}
    for _, adjacent in ipairs(_systemHelper.hexNeighborsWithHyperlanes(hex)) do
...
function _validateUnitModifier(name, unitModifier)
    ...
    assert(type(unitModifier.isCombat) == 'boolean', 'missing ' .. name .. '.isCombat')
